...
# Modified by p3dr0 to KTSR
# https://github.com/pedrozzz0/King-Tweaks
##########################################################################################
...
# Extract files
ui_print "[*] Extracting Minazuki Project files..."
...
# Install process
ui_print "[*] Installing Minazuki Project..."
...
[[ -d "$MODPATH/system/xbin" ]] && set_perm_recursive "$MODPATH/system/xbin" 0 0 0755 0755 u:object_r:system_xbin_file:s0
[[ -d "$MODPATH/system/lib" ]] && set_perm_recursive "$MODPATH/system/lib" 0 0 0755 0755 u:object_r:system_lib_file:s0
[[ -d "$MODPATH/system/lib64" ]] && set_perm_recursive "$MODPATH/system/lib64" 0 0 0755 0755 u:object_r:system_lib64_file:s0
[[ -d "$MODPATH/system/data/system" ]] && set_perm_recursive "$MODPATH/system/data/system" 0 0 0755 0755 u:object_r:data_system_file:s0
[[ -d "$MODPATH/system/vendor" ]] && set_perm_recursive "$MODPATH/system/vendor" 0 0 0755 0644 u:object_r:vendor_file:s0
[[ -d "$MODPATH/system/vendor/lib" ]] && set_perm_recursive "$MODPATH/system/vendor/lib" 0 0 0755 0755 u:object_r:vendor_lib_file:s0
[[ -d "$MODPATH/system/vendor/lib64" ]] && set_perm_recursive "$MODPATH/system/vendor/lib64" 0 0 0755 0755 u:object_r:vendor_lib64_file:s0
